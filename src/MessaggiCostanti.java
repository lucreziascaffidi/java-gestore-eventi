public class MessaggiCostanti {
    ...
    public static final String ERRORE_TITOLO_INCORRETTO = "Errore: Il titolo deve contenere almeno una lettera e non può essere vuoto. Riprova.";
    public static final String ERRORE_ANNO_INCORRETTO = "Errore: L'anno deve essere presente o futuro. Riprova.";
    public static final String ERRORE_MESE_INCORRETTO = "Errore: Il mese deve essere compreso tra 1 e 12. Riprova";
    public static final String ERRORE_DATA_PASSATA = "Errore: La data inserita è inesistente. Riprova.";
    ...
    public static final String INSERISCI_ANNO = "Inserisci l'anno (es. 2025):";
    public static final String INSERISCI_MESE = "Inserisci il mese (1-12):";
    public static final String INSERISCI_GIORNO = "Inserisci il giorno:";
    public static final String INSERISCI_NUMERO_POSTI = "Inserisci il numero totale di posti:";
    public static final String INSERISCI_ORARIO = "Inserisci l'orario dell'evento (HH:mm):";
